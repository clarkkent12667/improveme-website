            ...
            <div className="container relative z-10">
                ...
                >
                    ...
                    <a 
                        ...
                        className="inline-flex items-center gap-3 px-5 py-3.5 bg-white rounded-lg shadow-md border border-gray-200 hover:shadow-lg hover:border-gray-300 transition-all duration-300 group max-w-full"
                    >
